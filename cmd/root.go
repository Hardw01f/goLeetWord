...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.goLeetWord.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".goLeetWord" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".goLeetWord")
	}
